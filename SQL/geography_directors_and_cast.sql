...
-- KPI 1: Movies to TV Shows Ratio 
SELECT 
...
-- KPI 3: Average Movie Duration in Minutes 
SELECT 
...
-- KPI 5: Family & Animation Content Percentage 
SELECT 
...
-- KPI 6: Average Sub-Genres per Title 
SELECT 
...
-- Q3: Primary Genre Breakdown by Content Type 
SELECT 
    primary_genre,
...
-- Q5: Average Sub-Genres Count by Content Type 
SELECT 
    type,
...
-- Q6: Co-occurring Genres Frequency 
SELECT TOP 10
