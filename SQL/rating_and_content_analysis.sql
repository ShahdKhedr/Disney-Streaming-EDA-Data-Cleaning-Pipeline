...
-- KPI 2: Average Monthly Additions 
SELECT 
...
-- KPI 5: Modern Content Percentage 
SELECT 
...
-- KPI 6: Year-over-Year (YoY) Growth Rate % 
...
-- Q1: Annual Trend of Content Added 
SELECT 
    year_added,
    COUNT(show_id) AS total_titles_added
FROM disney_plus_titles_cleaned
...
-- Q2: Monthly Addition Rates by Content Type 
SELECT 
    month_added,
...
-- Q3: Preferred Day of the Week for Releases (
SELECT 
    day_name_added,
    COUNT(show_id) AS total_titles
FROM disney_plus_titles_cleaned
...
-- Q5: Speed of Adding Modern vs Classic Content 
SELECT 
    release_year,
    year_added,
    COUNT(show_id) AS titles_count,
...
-- Q6: Proportion of Movies vs TV Shows Added Annually 
SELECT 
    year_added,
